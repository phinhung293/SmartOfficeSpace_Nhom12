...
export default function Payment() {
    ...
    return (
        <div style={{ minHeight: "70vh", display: "flex", alignItems: "center", justifyContent: "center", padding: "40px 20px" }}>
            <div style={{ maxWidth: 520, width: "100%", background: "#fff", borderRadius: 16, boxShadow: "0 4px 24px rgba(0,0,0,0.08)", padding: 40, textAlign: "center" }}>
                ...
                {booking && (
                    <div style={{ background: "#f8fafc", borderRadius: 12, padding: 20, marginBottom: 24, textAlign: "left" }}>
                        ...
                        <div style={{ borderTop: "1px solid #e2e8f0", marginTop: 12, paddingTop: 12, display: "flex", justifyContent: "space-between" }}>
                            ...
                            <span style={{ fontWeight: 700, fontSize: 16, color: "#003db5" }}>{vnd(booking.totalAmount)}đ</span>
                        </div>

                        {/* Trạng thái */}
                        <div style={{ marginTop: 12, display: "flex", alignItems: "center", gap: 8 }}>
                            <span style={{ fontSize: 12, background: "#fef3c7", color: "#b45309", padding: "3px 10px", borderRadius: 20, fontWeight: 600 }}>
                                Chờ thanh toán
                            </span>
                ...
                <div style={{ display: "flex", gap: 12, justifyContent: "center" }}>
                    <button
                        ...
                        style={{ padding: "10px 24px", borderRadius: 8, border: "1.5px solid #003db5", background: "#fff", color: "#003db5", fontWeight: 600, cursor: "pointer", fontSize: 14 }}
                    >
                        Xem lịch sử đặt phòng
                    </button>
                    <button
                        onClick={() => navigate("/spaces")}
                        style={{ padding: "10px 24px", borderRadius: 8, border: "none", background: "#003db5", color: "#fff", fontWeight: 600, cursor: "pointer", fontSize: 14 }}
                    >
                        Tìm phòng khác
                    </button>
                </div>
