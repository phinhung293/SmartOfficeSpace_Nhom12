    ...
    return (
        <div className="auth-page">
            <div className="auth-card">
                ...
                {loginMessage && <div className="alert-error" style={{background:'#fef3c7',color:'#b45309',borderColor:'#fcd34d'}}><i className="fa-solid fa-circle-info" style={{marginRight:6}}></i>{loginMessage}</div>}
